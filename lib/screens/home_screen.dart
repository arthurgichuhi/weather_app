                ...
                BlocBuilder<WeatherBlocBloc, WeatherBlocState>(
                  builder: (context, state) {
                    if (state is WeatherBlocSuccess) {
                      var feelsLike = state.weather.main.feelsLike - 273;
                      var tempMin = state.weather.main.tempMin - 273;
                      var tempMax = state.weather.main.tempMax - 273;
                      return SizedBox(
                    ...
                    if (state is WeatherBlocFailure) {
                      debugPrint(
                          "Weather bloc failure ---------------------------------- ${state.error['Error']}");
                      debugPrint(
                          "Weather Bloc failure ********************* ${state.error['Stack-Error']}");
                    }
                    return Container();
                  },
                )
